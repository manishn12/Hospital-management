...
int main(){
	...
	cout<<endl;
	cout<<right<<setw(60)<<setfill(' ')<<"WELCOME TO Maharaja Surajmal HOSPITAL MANAGEMENT SYSTEM "<<endl;
	cout<<endl<<endl;
...
int chooseMain(){
	...
	int choice;
	cout<<endl;
	cout<<right<<setw(40)<<setfill(' ')<<"MAIN MENU"<<endl<<endl<<endl;
	...
	cout<<"\nEnter the number according to your choice:"<<endl;
	cin>>choice;
	return choice;
